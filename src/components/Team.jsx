        ...
        <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 "></div>
              ...
              <div className='md:w-2/3'>
                <p className='text-secondary md:w-1/2'>
                  Meet the experirnced team behind our successful digital marketing strategies 
                   </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/*show more btn*/}
          {
              visibleTeam < teamData.length && (  <div className="flex justify-evenly mt-8 w-full mr-8">
                <button 
                
                onClick={handleShowMore}

                className="inline-block bg-black text-white py-2 px-4 rounded-md font-semibold hover:bg-primary hover:text-black transition-all duration-300">See All</button>
              </div>)
          }
